...
<form action="post_contactT.php"  method="post" enctype="multipart/form-data">
                                <div class="row">
                                <div class="col-25">
                                    <p class="label" >Le Nom du srvice/entreprise</p>
                                </div>
                                <div class="col-75">
                                ...
                                <div class="row">
                                <div class="col-25">
                                    <p class="label" >Le Numero de telephone</p>
                                </div>
                                <div class="col-75">
                                    <input type="text" id="fname" name="num" placeholder="le numero de telephone">
                                </div>
                                </div>
                                <div class="row">
