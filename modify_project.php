...
<head>
  ...
  <div class="container">
                            <form action="modify_projectT.php"  method="post" enctype="multipart/form-data">
                                <div class="row">
                                <div class="col-25">
                                    <p class="label" >Le titre du projet a modifier</p>
                                </div>
                                <div class="col-75">
                                ...
                                <div class="row">
                                <div class="col-25">
                                    <p class="label" >la nouvelle date de fin estimee de projet</p>
                                </div>
                                <div class="col-75">
                                ...
                                <div>
                                <label for="state">Le nouvel etat d'avancement</label>
